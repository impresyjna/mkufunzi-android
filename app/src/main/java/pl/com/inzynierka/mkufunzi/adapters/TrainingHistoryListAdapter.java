...
public class TrainingHistoryListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<Training>> _listDataChild;

    public TrainingHistoryListAdapter(Context context, List<String> listDataHeader,
                                      HashMap<String, List<Training>> listChildData) {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        final Training childText = (Training) getChild(groupPosition, childPosition);
